...
class DataLoader:
    ...
    def initialize(self, data_path):
        ...
        file_path = os.path.join(data_path,"Trip_df.json")
    ...
    def load_data(self, data_path, index_dir):
        ...
        valid_csv = pd.read_csv(val_path)
        test_csv = pd.read_csv(test_path)
        # yelp
        # train_path = os.path.join(data_path,'train_df.json')
        # val_path = os.path.join(data_path,'val_df.json')
        # test_path = os.path.join(data_path,'test_df.json')
        # train_csv = pd.read_json(train_path)
        # valid_csv = pd.read_json(val_path)
        # test_csv = pd.read_json(test_path)
